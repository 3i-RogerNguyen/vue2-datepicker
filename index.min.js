!(function(e, t) {
  ...
  function D(e) {
    var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {},
      ...
      s = y(e),
      o = g(s, a),
      l = b(s, { firstDayOfWeek: a, firstWeekContainsDate: i }),
  ...
  function M(e) {
    var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : '',
      ...
      a = Math.abs(e),
      r = a % 60;
    return n + S(Math.floor(a / 60), 2) + t + S(r, 2);
  }
  ...
  function V(e, t) {
    var n,
      ...
      i = y(e);
    if (!v((n = i)) || isNaN(n.getTime())) return 'Invalid Date';
    var s = a.locale || w;
    return r.replace(C, function(e, t) {
      return t || ('function' == typeof T[e] ? ''.concat(T[e](i, s)) : e);
    });
  }
  function O(e) {
    return (
  ...
  function z(e, t) {
    ...
    try {
      ...
      return (
        void 0 !== h
          ? ((g[6] += 60 * h * 1e3), (m = U.apply(void 0, O(g))))
          : (m = B.apply(void 0, O(g))),
    ...
    Te = {
      ...
      methods: {
        ...
        getRangeClasses: function(e, t, n) {
          ...
          return 2 === t.length &&
            r(e, t) &&
            (0 === this.selectDays.length || this.selectDays.includes(Me(e)))
            ? a.concat('in-range')
  ...
  var Ve = pe(
        ...
        created: function() {
          (this.scrollbarWidth = (function() {
            ...
            return (
              (t.style.width = '100%'),
              e.appendChild(t),
              (xe = e.offsetWidth - t.offsetWidth),
    ...
    Ae = pe(
      ...
      {
        name: 'ListColumns',
        components: { ScrollbarVertical: Ve },
        inject: { prefixClass: { default: 'mx' } },
        props: {
          date: Date,
        ...
        methods: {
          getHoursList: function() {
            var e = this;
            return Ye(this.use12h ? 12 : 24, this.hourStep, this.hourOptions).map(function(t) {
          ...
          getMinutesList: function() {
            var e = this;
            return Ye(60, this.minuteStep, this.minuteOptions).map(function(t) {
              return { value: new Date(e.date).setMinutes(t), text: Oe(t) };
            });
          },
          getSecondsList: function() {
            var e = this;
            return Ye(60, this.secondStep, this.secondOptions).map(function(t) {
              return { value: new Date(e.date).setSeconds(t), text: Oe(t) };
            });
          },
  ...
  var Fe = pe(
    ...
    Pe = pe(
      ...
      {
        name: 'TimePanel',
        components: { ListColumns: Ae, ListOptions: Fe },
        inject: {
          getLocale: {
            default: function() {
              return he;
    ...
    je = {
      ...
      props: r({}, Se.props, {}, Pe.props, { showTimePanel: { type: Boolean, default: void 0 } }),
      data: function() {
      ...
      render: function() {
        var e = arguments[0],
          t = {
            props: r({}, ie(this.$props, Object.keys(Se.props)), {
              type: 'date',
          ...
          n = {
            props: r({}, ie(this.$props, Object.keys(Pe.props)), {
              showTimeHeader: !0,
              value: this.currentValue,
            }),
        ...
        return e('div', [
          e(Se, m([{}, t])),
          this.timeVisible && e(Pe, m([{ class: ''.concat(a, '-calendar-time') }, n])),
        ]);
      },
    },
    He = {
      ...
      inject: { prefixClass: { default: 'mx' } },
      emits: ['select', 'update:show-time-panel'],
      props: r({}, Te.props, {}, Ie.props, { showTimePanel: { type: Boolean, default: void 0 } }),
      data: function() {
        return { defaultTimeVisible: !1, currentValue: this.value };
      },
      computed: {
      ...
      render: function() {
        var e = arguments[0],
          t = {
            props: r({}, ie(this.$props, Object.keys(Te.props)), {
              type: 'date',
              value: this.currentValue,
            }),
            on: { select: this.handleSelect },
          ...
          n = {
            props: r({}, ie(this.$props, Object.keys(Ie.props)), {
              value: this.currentValue,
              showTimeHeader: !0,
            }),
            on: { select: this.emitDate, clicktitle: this.closeTimePanel },
        ...
        return e('div', [
          e(Te, m([{}, t])),
          this.timeVisible && e(Ie, m([{ class: ''.concat(a, '-calendar-time') }, n])),
        ]);
      },
    },
    Ee = { default: Se, time: Pe, datetime: je },
    Ne = { default: Te, time: Ie, datetime: He },
    Le = {
      name: 'DatePicker',
      provide: function() {
        var e = this;
                ...
                return (
                  re(a) &&
                    Object.keys(a).forEach(function(s) {
                      var o = a[s];
                      re(o) && re(n[s]) && (o = e(n[s], o)), (i = r({}, i, t({}, s, o)));
                    }),
                  i
                );
              })(he(), this.lang)
      ...
      methods: {
        ...
        parseDate: function(e, t) {
          ...
          var n = new Date();
          return z(e, t, { locale: this.locale.formatLocale, backupDate: n });
        },
        formatDate: function(e, t) {
          return (
            ...
            [
              ...
              this.showClearIcon
                ? e('i', { class: ''.concat(t, '-icon-clear'), on: { click: this.handleClear } }, [
                    this.renderSlot('icon-clear', e(ge)),
                  ])
        ...
        renderContent: function() {
          var e = this.$createElement,
            ...
            a = r({}, ie(this.$props, Object.keys(n.props)), {
              value: this.currentValue,
              selectedDays: this.selectedDays,
            }),
            i = r({}, ie(this.$listeners, n.emits || []), {
              select: this.handleSelectDate,
              selectDay: this.handleSelectDay,
            }),
            s = e(n, m([{}, { props: a, on: i, ref: 'picker' }]));
  ...
  return (
    ...
    'undefined' != typeof window && window.Vue && Le.install(window.Vue),
    n(Le, {
      CalendarPanel: Se,
      CalendarRange: Te,
      TimePanel: Pe,
