(function(global, factory) {
  ...
  function parse(str, format) {
    ...
    try {
      ...
      if (offset !== undefined) {
        ...
        parsedDate = createUTCDate.apply(void 0, _toConsumableArray$1(result));
      } else {
        parsedDate = createDate.apply(void 0, _toConsumableArray$1(result));
      } // check weekday
  ...
  var script$2 = {
    ...
    data: function data() {
      return {
        selectDays: _toConsumableArray(this.selectedDays || []),
      };
    },
    computed: {
    ...
    methods: {
      ...
      handleDayClick: function handleDayClick(day) {
        var dayIndex = this.selectDays.findIndex(function(item) {
          return item === day;
        });
                          ...
                          return _c(
                            ...
                            [
                              ...
                              _c('div', [
                                _vm._v(
                                  _vm._s(
                                    cell.getMonth() === _vm.calendar.getMonth()
                                      ? cell.getDate()
                                      : ''
                                  )
                                ),
    ...
    render: function render() {
      ...
      return h(__vue_component__$5, {
        ...
        on: {
          ...
          selectDay: function selectDay(days) {
            return _this.$emit('selectDay', days);
          },
          changepanel: this.handelPanelChange,
          changecalendar: this.handleCalendarChange,
        },
  ...
  var CalendarRange = {
    ...
    methods: {
      ...
      handleDaySelect: function handleDaySelect(days) {
    ...
    render: function render() {
      ...
      var calendarRange = this.calendars.map(function(calendar, index) {
        ...
        var on = {
          ...
          selectDay: _this2.handleDaySelect,
  ...
  var DatePicker = {
    ...
    methods: {
      ...
      handleSelectDay: function handleSelectDay(days) {
        this.$emit('selectDay', days);
      },
